...
combine_manual_and_data_avail_df <- function(full_data_avail_df, full_manual_df) {
  ...
  # make sure mods ok
  full_manual_df$responsible <- as.numeric(full_manual_df$responsible)
  full_data_avail_df$responsible <- as.numeric(full_data_avail_df$responsible)

  full_manual_df$PMA <- as.numeric(full_manual_df$PMA)
  full_data_avail_df$PMA <- as.numeric(full_data_avail_df$PMA)
